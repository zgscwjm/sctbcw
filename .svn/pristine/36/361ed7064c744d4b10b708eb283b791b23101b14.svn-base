							...
							<form class="form-horizontal style-form" id="edit_form">
								...
								<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:10px;">
										<input type="text" class="form-control" id="userId" name="userId" value="${teachStaffEnlargeInfo }" disabled>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:80px;">部门编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-11px;">
										<input type="text" class="form-control" id="depID" name="depID" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:110px;margin-left:70px;">身份证号码：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-10px;">
										<input type="text" class="form-control" id="IDNumber" name="IDNumber" value="${teachStaffEnlargeInfo }">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-10px;">
										<input type="text" class="form-control" id="presentWorkTime" name="presentWorkTime" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:60px;">参加工作时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
										<input type="text" class="form-control" id="startWorkTime" name="startWorkTime" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:120px;margin-left:80px;">毕业时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
										<input type="text" class="form-control" id="graduateTime" name="graduateTime" value="${teachStaffEnlargeInfo }">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="lastGraduateSchool" name="lastGraduateSchool" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:50px;">进入本单位形式：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="enterForm" name="enterForm" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">进入学院来源：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="enterSource" name="enterSource" value="${teachStaffEnlargeInfo }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="status" name="status" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:50px;">所学专业：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="schoolSpecialty" name="schoolSpecialty" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">现从事专业：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="workSpecialty" name="workSpecialty" value="${teachStaffEnlargeInfo }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="primaryPost" name="primaryPost" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:50px;">兼职岗位类别：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="secondaryPost" name="secondaryPost" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">岗位工资：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="postSalary" name="postSalary" value="${teachStaffEnlargeInfo }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="gradeSalary" name="gradeSalary" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:50px;">婚姻状态：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="marriage" name="marriage" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">政治面貌：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="political" name="political" value="${teachStaffEnlargeInfo }">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="highestEducation" name="highestEducation" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:50px;">最高学位：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="highestGrade" name="highestGrade" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">现任专业技术职务（职称）：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="specialtyRank" name="specialtyRank" value="${teachStaffEnlargeInfo }">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="interests" name="interests" value="${teachStaffEnlargeInfo }">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:140px;margin-left:50px;">身份类别：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="userType" name="userType" value="${teachStaffEnlargeInfo }">
									</div>
								</div>
								<!-- 妈蛋！！！终于加完了   好多玩意儿    复制都累！！ -->
								<div class="form-group">
