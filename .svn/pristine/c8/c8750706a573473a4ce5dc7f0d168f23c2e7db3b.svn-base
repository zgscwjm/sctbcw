					...
					<div class="col-md-12">
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<tbody>
								<c:forEach items="${resourcelist }" var="resourcedata">
									<tr>
										<td>${resourcedata.id }</td>
										<td class="hidden-phone">${resourcedata.resourceId}</td>
										<td>${resourcedata.privilege.privilegeName}</td>
										<td>${resourcedata.description}</td>
										<td>${resourcedata.uri}</td>
										<td>
											<button class="btn btn-success btn-xs" type="button" id="see_btn" dataid="${resourcedata.id }">
												<i class="fa fa-check"></i>
											</button>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${resourcedata.id }">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn"dataid="${resourcedata.id }">
