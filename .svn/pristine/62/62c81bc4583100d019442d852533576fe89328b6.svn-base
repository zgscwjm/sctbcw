						...
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${teachStaffInfoList }" var="teachStaffInfoData">
									<tr>
										<td>${teachStaffInfoData.id }</td>
										<td class="hidden-phone">${teachStaffInfoData.user.userId }</td>
										<td>${teachStaffInfoData.name }</td>
										<td>${teachStaffInfoData.sex }</td>
										<td>${teachStaffInfoData.ethnicity }</td>
										<td>
