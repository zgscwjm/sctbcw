      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 审核申请管理
				</h3>
							...
							<form class="form-horizontal style-form" id="add_form" method="POST">
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:160px;">审核部门：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="auditingDepartment" name="auditingDepartment">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:160px;margin-left:110px;">审核领导教职工编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="auditingLeaderUserID" name="auditingLeaderUserID">
									</div>
								</div>
								<div class="form-group">
									
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:150px;">培训申请：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainApplyId" name="trainApplyId">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:150px;margin-left:130px;">审核意见：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
									<select class="form-control" id="auditingOpinion" name="auditingOpinion">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">不同意的原因说明：</label>
