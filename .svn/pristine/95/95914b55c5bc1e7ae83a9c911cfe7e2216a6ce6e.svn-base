...
<body>
      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 新闻类型管理
				</h3>
				<div class="row mt">
					<div class="col-md-12">
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${newsTypeList }" var="newsTypedata">
									<tr>
										<td>${newsTypedata.id }</td>
										<td class="hidden-phone">${newsTypedata.name }</td>
										<td>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${newsTypedata.id }">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${newsTypedata.id }">
    ...
    <script src="<%=path%>/sctbc/js/NewsType/newsType.js"></script>
    <script src="<%=path%>/sctbc/js/NewsType/newsType_budle.js"></script>
</body>
</html>
