...
Left.prototype = {
	...
	shortPeriodEstimate : function(path) {
		window.location.href = path
				+ "/ShortPeriodEstimate/getShortPeriodEstimateAll";
	},
	longPeriodEstimate : function(path) {
		window.location.href = path
				+ "/LongPeriodEstimate/getLongPeriodEstimateAll";
	}
}