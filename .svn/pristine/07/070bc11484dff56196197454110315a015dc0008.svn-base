						...
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${deptInfoList }" var="deptInfodata">
									<tr>
										<td>${deptInfodata.depId }</td>
										<td class="hidden-phone">${deptInfodata.depName }</td>
										<td>${deptInfodata.depLeaderId }</td>
										<td>
											<button class="btn btn-success btn-xs" type="button" id="see_btn" dataid="${deptInfodata.id }">
												<i class="fa fa-check"></i>
											</button>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${deptInfodata.id }">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${deptInfodata.id }">
