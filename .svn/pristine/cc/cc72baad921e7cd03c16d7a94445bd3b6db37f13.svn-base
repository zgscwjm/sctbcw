							...
							<form class="form-horizontal style-form" id="edit_form">
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">培训信息发布部门：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="releaseDep" name="releaseDep">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">培训项目编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="projectID" name="projectID">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">培训项目名称：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainYear" name="trainYear">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">培训开始时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainStartTime" name="trainStartTime">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">培训结束时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainEndTime" name="trainEndTime">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainPlace" name="trainPlace">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">培训类别编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainCategory" name="trainCategory">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">培训人数：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainWay" name="trainWay">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">培训内容：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainContent" name="trainContent">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">送培人员：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainPerson" name="trainPerson">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">培训成果：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="trainResult" name="trainResult">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">借款时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="borrowTime" name="borrowTime">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">借款金额：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="borrowBalance" name="borrowBalance">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="rbAmountTime" name="rbAmountTime">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">报账金额：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="rbAmount" name="rbAmount">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">培训费用赔偿情况：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="costCompensated" name="costCompensated">
									</div>
								</div>
								<div class="form-group">
