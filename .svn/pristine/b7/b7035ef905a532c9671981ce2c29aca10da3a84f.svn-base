...
<body>
						...
						<div class="form-panel">
							...
							<form class="form-horizontal style-form" id="edit_form">
								<div class="form-group">
									...
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:150px;">新闻类型：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<select class="form-control" name="newsTypeId">
											<c:forEach items="${newsTypeList }" var="newsTypedata">
												<c:choose>
													<c:when test="${newsTypedata.id==news.newstype.id}">
													<option value="${newsTypedata.id }" selected="selected">${newsTypedata.name }</option>
													</c:when>
													<c:otherwise>
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:150px;">新闻内容：</label>
									<div class="col-sm-10" style="width:80%;margin-left:-20px;">
										<script id="editor" name="content" type="text/plain"
											style="height:200px;">${news.content}</script>
									</div>
								</div>
								<div class="form-group">
	...
	<script type="text/javascript" charset="utf-8"
		src="<%=path%>/sctbc/js/plug-in/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" charset="utf-8"
		src="<%=path%>/sctbc/js/plug-in/ueditor/ueditor.all.min.js">
		
	</script>
	<script type="text/javascript" charset="utf-8"
		src="<%=path%>/sctbc/js/plug-in/ueditor/lang/zh-cn/zh-cn.js"></script>
