							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${rolelist}" var="roledata">
									<tr>
										...
										<td>
											<button class="btn btn-success btn-xs" type="button" id="see_btn" dataid="${roledata.roleId}">
												<i class="fa fa-check"></i>
											</button>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${roledata.roleId}">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${roledata.roleId}">
