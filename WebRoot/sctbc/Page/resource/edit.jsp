...
<body>
      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 资源管理
				</h3>
							...
							<form class="form-horizontal style-form" id="edit_form">
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">资源编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="resourceID" name="resourceID" value="${resource.resourceId}">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">上传资料：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="file" class="form-control" id="uri" name="uri" value="${resource.uri}">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">设置权限：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<select class="form-control" id="privilegeID" name="privilegeID">
										<option selected="selected" value="${resource.privilege.privilegeId}">${resource.privilege.privilegeName}</option>
								...
								<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">描述：</label>
									<div class="col-sm-10" style="width:400px;margin-left:-20px;">
										<input type="text" class="form-control" id="description" name="description" value="${resource.}">
									</div>
								</div>
								<div class="form-group">
    ...
    <script src="<%=path%>/sctbc/js/Resource/resource.js"></script>
    <script src="<%=path%>/sctbc/js/Resource/resource_budle.js"></script>
