                  	  ...
                  	  <h4 class="mb" id="prompt_h4" style="height:50px;display:none;line-height:50px;"><i class="fa fa-angle-right"></i> <i id="prompt" style="left:20px;"></i></h4>
							<form class="form-horizontal style-form" id="edit_form">
								<div class="form-group">
									...
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">培训申请编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">审核领导教职工编号：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="auditingLeaderUserID" name="auditingLeaderUserID">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">审核意见：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="auditingOpinion" name="auditingOpinion">
									</div>
								</div>
								<div class="form-group">
