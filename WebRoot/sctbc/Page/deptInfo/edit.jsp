...
<html lang="en">
  ...
  <section id="container" >
                  ...
                  <div class="form-panel">
                      ...
                      <input type="hidden" name="id" value="${deptinfo.id }">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="width:100px;">部门编号：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                                  <input type="text" class="form-control" id="depID" name="depId" value="${deptinfo.depId }">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label" style="width:100px;">部门名称：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                                  <input type="text" class="form-control" id="depName" name="depName" value="${deptinfo.depName }">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label" style="width:130px;">部门领导教工：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                              <select   class="form-control" id="depLeaderID" name="depLeaderId">
                              <option selected="selected" value="${deptinfo.depLeaderId }">${deptinfo.depLeaderId }</option>
                              <c:forEach items="${teachStaffEnlargeInfolist }" var="TI">
                              <option value="${TI.user.userId }">${TI.user.userId }</option>
                              </c:forEach>
                              </select>
                              </div>
                          </div>
    ...
    <script src="<%=path%>/sctbc/js/DeptInfo/deptInfo.js"></script>
    <script src="<%=path%>/sctbc/js/DeptInfo/deptInfo_budle.js"></script>
