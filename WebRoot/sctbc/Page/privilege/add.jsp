...
<html lang="en">
  ...
  <section id="container" >
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" id="add_form">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="width:100px;">权限编号：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                                  <input type="text" class="form-control" id="privilegeID" name="privilegeID">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label" style="width:100px;">权限名称：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                                  <input type="text" class="form-control" id="privilegeName" name="privilegeName">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label" style="width:130px;">权限描述：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
    ...
    <script src="<%=path%>/sctbc/js/Privilege/privilege.js"></script>
    <script src="<%=path%>/sctbc/js/Privilege/privilege_budle.js"></script>
