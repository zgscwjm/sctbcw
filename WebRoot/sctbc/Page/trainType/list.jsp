						...
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${traintypeList }" var="traintypedata">
									<tr>
										<td>${traintypedata.trainkindId }</td>
										<td class="hidden-phone">${traintypedata.kindName }</td>
										<td>${traintypedata.procedure.name }</td>
										<td>
											<button class="btn btn-success btn-xs" type="button" id="see_btn" dataid="${traintypedata.trainkindId }">
												<i class="fa fa-check"></i>
											</button>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${traintypedata.trainkindId }">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${traintypedata.trainkindId }">
