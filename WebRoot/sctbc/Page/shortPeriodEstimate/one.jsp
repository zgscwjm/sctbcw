                  	  ...
                  	  <h4 class="mb" id="prompt_h4" style="height:50px;display:none;line-height:50px;"><i class="fa fa-angle-right"></i> <i id="prompt" style="left:20px;"></i></h4>
							...
							<input type="hidden" name="">
								<div class="form-group">
									<input type="hidden" name="id" value="${shortPeriodEstimate.id }">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">参培教工：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-40px;">
									<c:forEach  items="${shortPeriodEstimate.userByTrainUserId.teachstaffinfos }" var="usertrain">
									  <label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${usertrain.name }</label>
									...
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${shortPeriodEstimate.traininfo.projectName }</label>					
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:50px;">参评教工：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
									<c:forEach  items="${shortPeriodEstimate.userByEvaluateUserId.teachstaffinfos }" var="userevaluate">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${userevaluate.name }</label>
									</c:forEach>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${shortPeriodEstimate.necessity }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:30px;">满意度：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${shortPeriodEstimate.satisfaction }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">费用合理性：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${shortPeriodEstimate.costRationality }</label>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${shortPeriodEstimate.gainsDegree }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;">培训成果评价：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:20px;">${shortPeriodEstimate.evaluate }</label>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10" style="width:200px;">
										<!-- <button class="btn btn-theme04" type="button" id="edit">提交</button> -->
