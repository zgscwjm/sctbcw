...
<html lang="en">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> 新闻类型管理</h3>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" id="add_form">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="width:150px;">新闻标题：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                                  <input type="text" class="form-control" id="title" name="title">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label" style="width:150px;">新闻类型：</label>
                              <div class="col-sm-10" style="width:200px;margin-left:-20px;">
                              <select class="form-control" name="newsTypeId">
                                  <c:forEach items="${newsTypeList }" var="newsTypedata">
                                  <option value="${newsTypedata.id }">${newsTypedata.name }</option>
                                  </c:forEach>
                                  </select>
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="width:150px;">新闻内容：</label>
                              <div class="col-sm-10" style="width:80%;margin-left:-20px;">
                                   <script id="editor" name="content" type="text/plain" style="height:200px;"></script>
                              </div>
                          </div>
 ...
 <script type="text/javascript" charset="utf-8" src="<%=path%>/sctbc/js/plug-in/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<%=path%>/sctbc/js/plug-in/ueditor/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="<%=path%>/sctbc/js/plug-in/ueditor/lang/zh-cn/zh-cn.js"></script>
