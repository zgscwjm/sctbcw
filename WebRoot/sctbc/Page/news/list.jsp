							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${newsList }" var="newsdata">
									<tr>
										...
										<td class="hidden-phone">${newsdata.newstype.name }</td>
										<td>${newsdata.time }</td>
										<td>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${newsdata.id }">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${newsdata.id }">
