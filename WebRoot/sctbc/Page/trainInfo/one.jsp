      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 培训信息
				</h3>
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<h4 class="mb" id="title_h4">
								<i class="fa fa-angle-right"></i> 培训信息介绍
							</h4>
							...
							<form class="form-horizontal style-form" action="<%=path%>/Util/upLoadPXZL" id="upload_form"
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.trainYear }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:50px;">培训开始时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:200px;">${trainInfo.trainStartTime }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:30px;">培训结束时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:200px;">${trainInfo.trainEndTime }</label>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.trainWay }</label>
									</div>
									...
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.traintype.kindName }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:30px;">培训人数：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.numberOfPeople }</label>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:360px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.trainPlace }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:-110px;">培训内容：</label>
									<div class="col-sm-10" style="width:360px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:300px;">${trainInfo.trainContent }</label>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.trainPerson }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:50px;">文件资料：</label>
									<div class="col-sm-10" style="width:220px;margin-left:-20px;">
									<c:if test="${trainInfo.trainResult!='' }">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;"><a href="<%=path%>/${trainInfo.trainResult }">下载</a></label>
									</c:if>
										<c:if test="${trainInfo.trainResult=='' }">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">无</label>
									</c:if>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-50px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.borrowTime }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:50px;">借款金额：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.borrowBalance }</label>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.rbAmountTime }</label>
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:50px;">报账金额：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-50px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.rbAmount }</label>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:580px;margin-left:-20px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.costCompensated }</label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:580px;margin-left:-105px;">
										<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">${trainInfo.memo }</label>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10" style="width:200px;">
										<button class="btn btn-theme04" type="button" id="sq" dataid="${trainInfo.projectId }">申请</button>
