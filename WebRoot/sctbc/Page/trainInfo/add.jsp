				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							 <h4 class="mb" id="title_h4"><i class="fa fa-angle-right"></i> 发布培训信息</h4>
                  	  <h4 class="mb" id="prompt_h4" style="height:50px;display:none;line-height:50px;"><i class="fa fa-angle-right"></i> <i id="prompt" style="left:20px;"></i></h4>
							<form class="form-horizontal style-form" id="add_form" method="POST">
								...
								<label class="col-sm-2 col-sm-2 control-label"
									...
									<div class="col-sm-10" style="width:200px;margin-left:-30px;">
									<select  class="form-control" id="trainCategory" name="trainCategory">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">上传成果：</label>
									<div class="col-sm-10" style="width:220px;margin-left:-20px;">
										<input type="file" class="form-control" id="trainResult" name="trainResult">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:40px;">借款时间：</label>
								...
								<div class="form-group">
									...
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:130px;margin-left:60px;">报账金额：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-50px;">
