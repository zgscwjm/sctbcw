	...
	<section id="container">
      ...
      *********************************************************************************************************************************************************** -->
						...
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<c:forEach items="${userlist}" var="userdata">
									<tr>
										<td class="hidden-phone">${userdata.userId}</td>
										<td>${userdata.roles.roleName}</td>
										<td>
											<button class="btn btn-success btn-xs" type="button" id="see_btn" dataid="${userdata.userId}">
												<i class="fa fa-check"></i>
											</button>
											<button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${userdata.userId}">
												<i class="fa fa-pencil"></i>
											</button>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${userdata.userId}">
		...
		<footer class="site-footer"
			style="margin-top:255px;width:100%;">
