				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							...
							<form class="form-horizontal style-form" id="edit_form" method="post">
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										...
										<option selected="selected" value="${user.roles.roleId}"><font color="red">${user.roles.roleName}</font></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="password" class="form-control"
											id="RepeatPassword" value="${user.password}">
									</div>
								</div>
								<div class="form-group" style="width:60%;">
									...
									<a class="btn btn-default btn-sm pull-right" href="javascript:;" dataid="${user.userId}" id="getuserinfo_btn">职工其他数据</a>
								</div>
							</form>
						</div>
					</div>
