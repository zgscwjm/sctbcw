	...
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			<c:forEach items="${USER.teachstaffinfos}" var="userinfo">
				...
				<c:if
					test="${USER.teachstaffenlargeinfos==null||USER.teachstaffenlargeinfos=='[]' }">
					<p class="centered">
						所在部门：<font color="red"><a href="<%=path%>/TeachStaffEnlargeInfo/editTeachStaffEnlargeInfoIndex?userId=${USER.userId }">请编辑扩展信息</a></font>
					</p>
				</c:if>
				<c:forEach items="${USER.teachstaffenlargeinfos }"
					var="user_deptinfo">
					<p class="centered">所在部门：${user_deptinfo.deptinfo.depName }</p>
				</c:forEach>
			...
			<li class="sub-menu"><a href="javascript:;"> <i
					class="fa fa-book"></i> <span>培训信息管理</span>
			</a>
				<ul class="sub">
			...
			<li class="sub-menu"><a href="javascript:;"> <i
				...
				<ul class="sub">
					<li><a href="javascript:;" id="trainApply">培训申请管理</a></li>
			...
			<li class="sub-menu"><a href="javascript:;"> <i
				...
				<ul class="sub">
					<li><a href="javascript:;" id="longPeriodEstimate">长期评价</a></li>
					<li><a href="javascript:;" id="shortPeriodEstimate">短期评价</a></li>
					<li><a href="lock_screen.html">查询评价结果</a></li>
				</ul></li>
			<li class="sub-menu"><a href="javascript:;"> <i
