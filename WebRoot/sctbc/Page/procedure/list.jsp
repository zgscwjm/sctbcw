      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i>流程管理
				</h3>
				<div class="row mt">
					<div class="col-md-12">
							...
							<div class="form-panel">
								<form class="form-inline" id="search_form" role="form">
									...
									<a class="btn btn-default btn-sm pull-right"
										href="<%=path%>/Procedure/addProcedureIndex" id="add_index_a">新增流程</a>
								</form>
							</div>
							<table class="table table-striped table-advance table-hover">
								...
								<tbody id="data">
									<c:forEach items="${procedureList }" var="procedureList">
										<tr>
											<td>${procedureList.id }</td>
											<td class="hidden-phone">${procedureList.name }</td>
											<td>
												<button class="btn btn-success btn-xs" type="button"
													title="详情" id="see_btn" dataid="${procedureList.id }">
													<i class="fa fa-check"></i>
												</button> <%-- <button class="btn btn-primary btn-xs" type="button" id="edit_btn" dataid="${deptInfodata.id }">
						...
						<div class="form-panel" id="showOne" style="display:none">
