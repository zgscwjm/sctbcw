...
<body>
                  	  ...
                  	  <h4 class="mb" id="prompt_h4" style="height:50px;display:none;line-height:50px;"><i class="fa fa-angle-right"></i> <i id="prompt" style="left:20px;"></i></h4>
							<form class="form-horizontal style-form" id="edit_form">
								<div class="form-group">
									...
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">项目状态：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;">服务时间：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="serveTime" name="serveTime">
									</div>
									<label class="col-sm-2 col-sm-2 control-label"
										style="width:100px;margin-left:100px;">评价分值：</label>
									<div class="col-sm-10" style="width:200px;margin-left:-20px;">
										<input type="text" class="form-control" id="evaluateMark" name="evaluateMark">
									</div>
									</div>
								<div class="form-group">
    ...
    <script src="<%=path%>/sctbc/js/TeachStaffTrainInfo/teachStaffTrainInfo.js"></script>
    <script src="<%=path%>/sctbc/js/TeachStaffTrainInfo/teachStaffTrainInfo_budle.js"></script>
