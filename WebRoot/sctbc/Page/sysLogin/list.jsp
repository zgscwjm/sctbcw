      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 系统日志管理
				</h3>
				<div class="row mt">
					<div class="col-md-12">
						<div class="content-panel">
							...
							<table class="table table-striped table-advance table-hover">
								...
								<tbody>
								<c:forEach items="${sysLoginlist }" var="sysLogindata">
									<tr>
										<td>${sysLogindata.loginId }</td>
										<td class="hidden-phone">${sysLogindata.userId }</td>
										<td>${sysLogindata.loginIp }</td>
										<td>${sysLogindata.loginTime }</td>
										<td>
											<button class="btn btn-danger btn-xs" type="button" id="del_btn" dataid="${sysLogindata.loginId }">
